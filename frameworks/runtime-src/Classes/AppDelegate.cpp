...
bool AppDelegate::applicationDidFinishLaunching()
{
    ...
    if(!glview) {
        ...
        glview = cocos2d::GLViewImpl::create("AdventureJam2016");
#else
    glview = cocos2d::GLViewImpl::createWithRect("AdventureJam2016", Rect(0,0,1280,720));
//    glview = cocos2d::GLViewImpl::createWithRect("AdventureJam2016", Rect(0, 0, 640, 360));
